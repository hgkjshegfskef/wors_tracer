...
checker2d_pattern::checker2d_pattern(pattern first, pattern second) noexcept
    : first{std::move(first)}, second{std::move(second)}, tform{}, inv_tform{} {}

checker2d_pattern::checker2d_pattern(pattern first, pattern second, tform4 tform) noexcept
