...
color lighting(material const& material, pnt_light const& light, pnt3 const& point,
    ...
    color diffuse{0, 0, 0};  // black
    color specular{0, 0, 0}; // black
    ...
    if (light_dot_normal >= 0.) {
        ...
        //        auto reflect_vector = reflect(in: -light_vector, n: normal_vector);
        auto reflect_vector = tform4(reflection(normal_vector)) * -light_vector;
